...
<body class="">
    <div class="LaND-container center">
        ...
        <div class="col ml-1-3 s-pad-0 s-text-center">
            <a id="img0" class="col s-pad-0 air grayscale" data-lazy="true" data-class="s-fill" href="http://lorempixel.com/1150/1150/abstract/1/900"
               data-srcs='{
                ...
                <script>document.write('<img class="s-fill" src="/assets/images/1x1.gif" />');</script>
        ...
        <div class="col ml-2-3 s-pad-0 s-text-center">
            <a id="img2" class="col s-pad-0 air" data-lazy="true" data-class="s-fill" href="/assets/images/test_images/balloon_1150x575.jpg"
               data-srcs='{
                ...
                <script>document.write('<img class="s-fill" src="/assets/images/2x1.gif" />');</script>
                <noscript><img class="s-fill" src="/assets/images/test_images/balloon_1150x575.jpg" /></noscript>
            </a>
        </div>
