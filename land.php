<?php
    ...
    $url_path_to_land = '/css/';

    $enable_land_js = false; // Not ready yet
?>
<!-- BEGIN LaND -->
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo $url_path_to_land; ?>normalize.css">
        ...
        <script>
            if (window.matchMedia) {
                ...
                function loadResponsiveCSS() {
                    ...
                    ref.setAttribute("href", "<?php echo $url_path_to_land; ?>land-respond.css");
                    document.getElementsByTagName("head")[0].appendChild(ref);
                }

                if (mm.matches) {
                    document.write('<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $url_path_to_land; ?>land-respond.css">');
                } else {
                ...
                document.write('<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $url_path_to_land; ?>land-desktop.css">');
            }
        </script>
        <noscript><link rel="stylesheet" type="text/css" media="screen" href="<?php echo $url_path_to_land; ?>land-desktop.css"></noscript>
        <!--<![endif]-->
